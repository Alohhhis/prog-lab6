...
object KAnySerializer : KSerializer<Any> {
    ...
    override val descriptor: SerialDescriptor = buildSerialDescriptor("AnySerializer", PolymorphicKind.SEALED) {
        ...
        element<Int>("int")
        element("vehicle", Vehicle.serializer().descriptor)
        element("vehicleType", VehicleType.serializer().descriptor)
    ...
    override fun serialize(encoder: Encoder, value: Any) {
        ...
        when (value) {
            ...
            is Vehicle -> encoder.encodeSerializableValue(Vehicle.serializer(), value)
            is VehicleType -> encoder.encodeSerializableValue(VehicleType.serializer(), value)
    ...
    override fun deserialize(decoder: Decoder): Any {
        ...
        return when {
            ...
            jsonElement.isObject() && jsonElement.jsonObject.containsKey("name") -> jsonDecoder.json.decodeFromJsonElement(
                Vehicle.serializer(), jsonElement
            )
            //Array<Any>
